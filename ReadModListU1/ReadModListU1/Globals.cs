...
namespace ReadModList
{
    static class Globals
    {
        ...
        public static string UnitDataBase = "[ModList].[dbo].[Unit1]";
        public static string InputFilePath = @"D:\g_in_pda_unit1";
        public static string OutputFilePath = @"D:\ModList-Unit1.txt";
