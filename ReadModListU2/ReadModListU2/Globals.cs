...
namespace ReadModList
{
    static class Globals
    {
        ...
        public static string UnitDataBase = "[ModList].[dbo].[Unit2]";
        public static string InputFilePath = @"D:\g_in_pda_unit2";
        public static string OutputFilePath = @"D:\ModList-Unit2.txt";
